...
def voc() -> dict:
    vocabulaire = {
                ...
                16.2 : {
                        "jn. beschimpfen": "insulter qqn",
                        "jn. belästigen": "harceler qqn (All lit)",
                        "jn mobben" :"harceler qqn (ALL Agl)",
                        "sich schämen": "avoir honte",
                        "Opfer werden": "devenir une victime",
                        "der Täter (-)": "le coupable, le responsable",
                        "jn. blockieren": "bloquer qqn",
                        "offline gehen": "se déconnecter",
                        "sich Hilfe holen": "chercher de l'aide",
                        "sich an etw. (D) schützen": "se protéger de qqch",
                        },
                16.3: {
                       "die Verschwörung": "le complot, la conspiration",
                       "hinter etw. (D) stecken": "se cacher derrière qqch (sens abstrait)",
                       "geheim": "(en) secret",
                       "das geheim": "le secret",
                       "jm / an etw (D) glauben": "croire qqn / en qqch",
                       "jm vertrauen": "faire confiance à qqn",
                       "jm misstrauen": "se méfier de qqn",
                       "eine Falschmeldung / Fake News verbreiten": "diffuser une fausse informations",
                       "die Lüge (-n)": "le mensonge",
                       "lugen": "mentir",
                       "die Quelle überprüfen": "vérifier la source",
                       "die Verantwortung": "La responsabilité",
                       "verantwortungsvoll": "(de manière) responsable",
                       "etw. beherrschen": "maitriser qqch",
                       "die Gefahr (-en)": "le danger",
                       "mit etw. (D) um/gehen": "se servir de qqch",
                       "etw. benutzen": "utiliser qqch"}
                    }
